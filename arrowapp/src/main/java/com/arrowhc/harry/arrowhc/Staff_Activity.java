...
public class Staff_Activity extends AppCompatActivity {
     TextView tv;ListView lv;ArrayList<HashMap<String,String>> arrayList;String id,name; Button addpatients; String user; TextView userr;
    RequestQueue requestQueue;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staff_);
        addpatients = (Button)findViewById(R.id.button2);

        //userr = (TextView) findViewById(R.id.usern);
        String rr=getIntent().getStringExtra("");
        ...
        addpatients.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(getBaseContext(),Add_patients.class);
                intent.putExtra("doc",name);
